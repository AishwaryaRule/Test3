...
iface = gr.Interface(
    fn=generate_letter,
    inputs=[
        gr.Textbox(default="Dr. Jane Smith", lines=1, label="Physician's Name"),
        gr.Textbox(default="1234 Main St.", lines=1, label="Physician's Address"),
        gr.Textbox(default="Boston, MA, 02110", lines=1, label="Physician's City, State, ZIP"),
        gr.Textbox(default="jane.smith@example.com", lines=1, label="Physician's Email Address"),
        gr.Textbox(default="(555) 123-4567", lines=1, label="Physician's Phone Number"),
        gr.Textbox(default="XYZ Health Insurance", lines=1, label="Health Insurance Company Name"),
        gr.Textbox(default="Medical Claims Department", lines=1, label="Claims Department"),
        gr.Textbox(default="5678 Elm St.", lines=1, label="Company Address"),
        gr.Textbox(default="Boston, MA, 02111", lines=1, label="Company City, State, ZIP"),
        gr.Textbox(default="John Doe", lines=1, label="Patient's Name"),
        gr.Textbox(default="ABC123456", lines=1, label="Policy Number"),
